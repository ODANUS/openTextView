    ...
    HistoryBox: EntityDefinition<HistoryBox>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = HistoryBox(
              ...
              imageUri: const fb.StringReader(asciiOptimization: true)
                  .vTableGet(buffer, rootOffset, 22, ''),
              searchKeyWord: const fb.StringReader(asciiOptimization: true)
    ...
    FilterBox: EntityDefinition<FilterBox>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = FilterBox(
              ...
              filter: const fb.StringReader(asciiOptimization: true)
    ...
    SettingBox: EntityDefinition<SettingBox>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = SettingBox(
              ...
              fontFamily: const fb.StringReader(asciiOptimization: true)
                  .vTableGet(buffer, rootOffset, 10, ''),
              customFont: const fb.StringReader(asciiOptimization: true)
              ...
              audiosession: const fb.BoolReader().vTableGet(buffer, rootOffset, 28, false),
              audioduck: const fb.BoolReader().vTableGet(buffer, rootOffset, 52, false),
              touchLayout: const fb.Int64Reader().vTableGet(buffer, rootOffset, 22, 0),
              useClipboard: const fb.BoolReader().vTableGet(buffer, rootOffset, 24, false),
              enablescroll: const fb.BoolReader().vTableGet(buffer, rootOffset, 32, false),
              theme: const fb.StringReader(asciiOptimization: true).vTableGet(buffer, rootOffset, 30, ''),
              lastDevVersion: const fb.StringReader(asciiOptimization: true).vTableGet(buffer, rootOffset, 34, ''),
