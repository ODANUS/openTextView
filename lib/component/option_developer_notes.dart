...
* 처음 이 어플 을 만들때 TTS 만 제대로 만들자는 생각 으로 제작 하게 되었습니다. 
  마켓에 어플을 등록하면서 TTS 만을 강조 하였기때문에 TTS 사용분들만 유입 될꺼라 생각 했고. 
  사용자가 상당히 적을꺼라 생각 했었습니다.
  
  제가 TTS 로 책을 듣는다고 하면 대부분 이상하게 보니까 TTS 로 책듣는 사람도 적을꺼라 생각 했거든요. 
  
  만약 주변에 책을 듣는 분이 있다면 이 어플을 추천해 주세요! 
""";
