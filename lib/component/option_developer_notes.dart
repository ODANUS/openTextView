...
1. OCR 버튼 (이미지 텍스트변환) 이 ZIP 으로 표기 되던 문제 수정. 
  - 언제 제가 이걸 수정 했는지 모르겠지만. 내서재 부분 개선하면서 실수로 변경 한거 같습니다. 

2. 리워드 광고 를 전면 광고로 교체 하였습니다. 
  - 전면광고는 5초 ~ 7초 정도 되는 광고라서 비교적 빨리 뜨는데. 리워드는 30초정도로 긴 광고 라서 뜨는데 너무 오래 걸려요. 
  - 제가 성격이 급해서 30초 광고는 전부 빼버렸습니다. 
  - 로딩 대신 겸사겸사 넣은 광고인데. 30 초 광고는 오히려 광고 로딩 시간때문에 변환시간이 더 걸리는거 같아요. 

3. 이 어플에 기반이 되는 flutter 가 어제 3.0 을 발표 했습니다. 제 어플 엔진도 3.0 으로 업데이트 하였습니다. 
 - 수정된 사항은 대략 517 개 입니다. 무슨 차이가 있는지는 솔직히 체감되지 않습니다.  
 - 517 개 수정사항 검토후 제 어플에 뭔가 도움 될만한게 있다면 추후 기능을 추가 하도록 하겠습니다. 

* 아이폰 며칠 사용하면서 답답합을 많이 느끼고 있습니다. 
  뒤로 가기 버튼이 없다보니. x버튼이 한참뒤에 나오는 몇몇 광고는 끌 방법이 없습니다. 
  안드로이드는 대충 7 초정도 지난뒤 뒤로 가기 버튼 누르면 광고가 꺼지는데. 
  아이폰은 그게안되니까 7초 광고도 X버튼이 나올때까지 기다려야 합니다. 

* 리뷰는 동기부여가 됩니다. 
  메일이 오거나 리뷰가 달리면 '누군가는 이 어플을 사용하고 계시는구나' 라는 생각이 들어요.
  리뷰 한번씩 부탁 드립니다. 
  개선 요청 하는 리뷰가 큰 도움이 됩니다.
